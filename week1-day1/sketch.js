...
function draw() // calls every framerate
{
    ...
    //1st row
    rect(100, 100, 50, 50);// 1 x, y, width, height 
    rect(160, 100, 50, 50);// 2 x, y, width, height 
    rect(220, 100, 50, 50);// 3 x, y, width, height 
    rect(280, 100, 50, 50);// 4 x, y, width, height 
    rect(340, 100, 50, 50);// 5 x, y, width, height 
